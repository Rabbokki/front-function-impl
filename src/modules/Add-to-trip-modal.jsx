...
export function AddToTripModal({ isOpen, onClose, placeName, placeType, placeLocation }) {
  ...
  const handleAddToTrip = () => {
    if (
      ...
      // 기존 여행에 장소 추가 로직
      const tripName =
        myTrips.find((trip) => trip.id === selectedTripId)?.title || '여행';
      toast({
        title: '장소가 추가되었습니다',
        description: `${placeName}이(가) ${tripName}의 ${
          selectedDayIndex + 1
        }일차에 추가되었습니다.`,
      });
      onClose();
  ...
  const handleNewTripChange = (field, value) => {
    setNewTripData((prev) => ({
      ...prev,
      [field]: value,
    }));
      ...
      <DialogContent className="max-w-2xl">
              ...
              {!isAddingToDay ? (
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="font-medium text-[#1e3a8a]">
                      {
                        myTrips.find((trip) => trip.id === selectedTripId)
                          ?.title
                      }
                    </h3>
                    <Button
                        ...
                        >
                          <CardContent className="flex items-center justify-center p-4">
                            <div className="text-center">
                              ...
                              {selectedDayIndex === i && (
                                <Check className="mx-auto mt-1 h-4 w-4 text-[#4dabf7]" />
                              )}
                            </div>
                          </CardContent>
                        </Card>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleNewTripChange('title', e.target.value)
                    }
                    className="bg-[#f8f9fa]"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleNewTripChange('description', e.target.value)
                    }
        ...
        <div className="mt-4 flex justify-end space-x-2">
          ...
          <Button
            ...
            disabled={
              (activeTab === 'existing' &&
                (selectedTripId === null || selectedDayIndex === null)) ||
