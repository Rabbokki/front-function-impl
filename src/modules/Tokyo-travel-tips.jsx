...
export function TokyoTravelTips() {
  ...
  const postDate = new Date("2025-04-18T10:30:00")
  const relativeTime = formatDistanceToNow(postDate, { addSuffix: true, locale: ko })
  ...
  const comments = [
    {
      ...
      date: "2025-04-18T14:25:00",
      likes: 12,
    },
    {
      id: 2,
      author: "초보여행자",
      authorImage: "/placeholder.svg?key=7xcj1",
      content: "스이카 카드는 어디서 구매할 수 있나요? 공항에서도 살 수 있나요?",
      date: "2025-04-18T15:40:00",
      likes: 3,
    },
    {
      id: 3,
      ...
      <div className="relative h-64 sm:h-80 md:h-96">
        ...
        <div className="absolute bottom-0 left-0 p-6">
          ...
          <div className="flex items-center text-white/90">
            ...
            <span className="mr-4">{relativeTime}</span>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="relative h-48 rounded-lg overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=600&query=Tokyo Metro Map"
                      alt="도쿄 메트로 지도"
                      fill
                  ...
                  <div className="relative h-48 rounded-lg overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=600&query=Suica Card and Tokyo Train"
                      alt="스이카 카드와 도쿄 전철"
                      fill
                      className="object-cover"
                    />
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                  <div className="relative h-48 rounded-lg overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=600&query=Shinjuku Hotel Room"
                      alt="신주쿠 호텔 객실"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div className="relative h-48 rounded-lg overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=600&query=Asakusa Traditional Ryokan"
                      alt="아사쿠사 전통 료칸"
                      fill
                      className="object-cover"
                    />
                ...
                <div className="bg-[#fff9db] p-4 rounded-lg border border-[#ffd43b]">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>도쿄는 연중 관광객이 많으니 최소 2-3개월 전에 예약하는 것이 좋아요.</li>
                    <li>
                      체크인/체크아웃 시간을 확인하세요. 일본 호텔은 보통 체크인이 늦고(15:00) 체크아웃이 이른(10:00)
                      편이에요.
                    </li>
                    <li>료칸(전통 숙소)에서의 하룻밤도 특별한 경험이 될 수 있어요.</li>
                    <li>비즈니스 호텔은 작지만 깨끗하고 저렴한 옵션입니다.</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-medium text-lg mb-1">긴자</h3>
                      <p>
                        고급 브랜드 쇼핑을 즐기고 싶다면 긴자를 추천해요. 유니클로, 무인양품의 플래그십 스토어도 있어
                        일본 브랜드를 경험하기 좋습니다.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-[#fff9db] p-4 rounded-lg border border-[#ffd43b]">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>여권을 지참하면 5,000엔 이상 구매 시 면세 혜택을 받을 수 있어요.</li>
                    <li>백화점에서는 외국인 전용 할인 쿠폰을 제공하는 경우가 많으니 인포메이션 센터에 문의해보세요.</li>
                    <li>일본 전통 기념품은 아사쿠사의 나카미세 거리에서 구매하기 좋아요.</li>
                    <li>약국 체인점인 마츠모토 키요시에서는 화장품, 의약품 등을 저렴하게 구매할 수 있어요.</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <div className="bg-[#e7f5ff] p-2 rounded-full mr-4 mt-1">
                      <Utensils className="h-5 w-5 text-[#4dabf7]" />
                    </div>
                    <div>
                      <h3 className="font-medium text-lg mb-1">음식점 이용 팁</h3>
                      <p>
                        관광지 주변 식당에는 영어 메뉴가 있는 곳이 많아요. 입구에 음식 모형이 전시된 곳도 많아 메뉴
                        선택이 쉬워요. 일본에서는 팁 문화가 없으니 팁을 주지 않아도 됩니다.
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="relative h-48 rounded-lg overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=600&query=Tokyo Street Food"
                      alt="도쿄 길거리 음식"
                      fill
                      className="object-cover"
                    />
                  ...
                  <div className="relative h-48 rounded-lg overflow-hidden">
                    <Image
                      src="/placeholder.svg?height=400&width=600&query=Tokyo Convenience Store"
                      alt="도쿄 편의점"
                      fill
                      className="object-cover"
                    />
                ...
                <div className="bg-[#fff9db] p-4 rounded-lg border border-[#ffd43b]">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>쓰레기통이 거의 없어요. 쓰레기는 가방에 넣어두었다가 숙소나 편의점에서 버리세요.</li>
                    <li>도쿄는 매우 안전한 도시지만, 귀중품 관리에는 항상 주의하세요.</li>
                    <li>일본어를 몰라도 괜찮아요. 기본적인 인사말만 알아도 현지인들이 친절하게 대해줍니다.</li>
                    <li>날씨를 미리 확인하고 우산이나 적절한 옷을 준비하세요.</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
